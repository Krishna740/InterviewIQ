...
function Step1SetUp({ onStart }) {
    ...
    const handleUploadResume = async () => {
        ...
        try {
            ...
            console.log(error)
            setResumeError(error.response?.data?.message || "Failed to analyze resume. Please try again.");
            setAnalyzing(false);
        }
    }
    ...
    const handleStart = async () => {
        ...
        if (userData?.credits < 50) {
            setError("Insufficient credits. You need at least 50 credits to start an interview. Please buy more credits.");
            return;
        }
                ...
                <motion.div
                    ...
                    {error && (
                        <motion.div
                            ...
                            className='bg-red-50 border border-red-200 rounded-xl p-4 mb-6 text-red-700 flex items-start gap-3'>
                    ...
                    <div className='bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6'>
                        <p className='text-sm text-blue-700'>
                            <span className='font-semibold'>Available Credits:</span> {userData?.credits || 0} (50 credits required per interview)
                        </p>
                    </div>
